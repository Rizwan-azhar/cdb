            ...
            <div class="col-md-12">
               <div class="row justify-content-center mb-4">
                  <div class="col-md-8 text-center  form-search-wrap" style="margin-top: 15%" >
                     <h1 style="color: black; font-weight: 800" class="" data-aos="fade-up">Customer Dashboard </h1>
                  </div>
               </div>
...
<div class="col-md-7 mb-0" data-aos="fade">

<form action="#" class="p-5 bg-white">
<h3 class="mb-5 text-center">You need to login to edit your profile.</h3>
