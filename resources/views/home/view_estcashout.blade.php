        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-title">Est. Cash Outs</h6>
                    <!-- Modal -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#product_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('ajax-estcashout.index') }}",
                },
                columns: [
            ...
            $('#btn-submit').on('submit', function(event){
                ...
                if($('#action').val() == 'Add')
                {
                    ...
                    $.ajax({
                        url:"{{ route('ajax-estcashout.store') }}",
                        method:"POST",
                ...
                if($('#action').val() == "Edit")
                {
                    ...
                    $.ajax({
                        url:"{{ route('ajax-estcashout.update') }}",
                        method:"POST",
                        data:new FormData(this),
                        contentType: false,
                        cache: false,
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            ...
                            $.ajax({
                                url:"ajax-estcashout/destroy/"+user_id,
                                beforeSend:function(){
                            ...
                            swal("Cash deleted successfully!", {
                                icon: "success",
                            });
                        }
                    });
