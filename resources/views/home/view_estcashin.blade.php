        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-title">Est. Cash Ins</h6>
                    <!-- Modal -->
                    <div id="productModal" class="modal fade" role="dialog">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Add New Cash In</h5>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#product_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('ajax-estcashin.index') }}",
                },
                columns: [
            ...
            $('#create_product').click(function(){
                $('.modal-title').text("Add New Cash In");
            ...
            $('#btn-submit').on('submit', function(event){
                ...
                if($('#action').val() == 'Add')
                {
                    ...
                    $.ajax({
                        url:"{{ route('ajax-estcashin.store') }}",
                        method:"POST",
                ...
                if($('#action').val() == "Edit")
                {
                    ...
                    $.ajax({
                        url:"{{ route('ajax-estcashin.update') }}",
                        method:"POST",
                        data:new FormData(this),
                        contentType: false,
                        cache: false,
                        ...
                        success:function(response){
                            if(response.success){
                                swal({
                                    text: "Cash In Updated Successfully!",
                                    icon: "success",
                                    button: "Done!",
            ...
            $(document).on('click', '.edit', function(){
                ...
                $('#form_result').html('');
                $.ajax({
                    url:"/ajax-estcashin/"+id+"/edit",
                    dataType:"json",
                    success:function(html){
                        $('#job_id').val(html.job.name);
                        $('#amount').val(html.data.amount);

                        $('#hidden_id').val(html.data.id);
                        $('.modal-title').text("Edit Cash-In");
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            ...
                            $.ajax({
                                url:"ajax-estcashin/destroy/"+user_id,
                                beforeSend:function(){
                            ...
                            swal("Cash In deleted successfully!", {
                                icon: "success",
                            });
                        }
                    });
