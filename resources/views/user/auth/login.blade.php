...
<head>
    ...
    <title>African Drone | Login Page</title>
                                        ...
                                        <form method="post" action="{{ url('login') }}" class="forms-sample">
                                            ...
                                            <div class="mt-3">
                                                <input type="hidden" name="_token" value={{csrf_token()}}>
                                                 <p style="color:#30e3ca; cursor: pointer; float: right ">Forgot Password?</p>
                                                <button type="submit"
                                                    class="btn btn-primary btn-block mr-2 mb-2 mb-md-0 text-white" style="background-color: #30e3ca; color: white">Login</button>

                                                    <div class="mt-3 text-center">
                                                  
                                                     <a href="/register"><p style="color:#30e3ca; cursor: pointer;" >New Here? Create an account</p></a>
                                                    </div>
                                            </div>
                                        </form>
                                    </div>
